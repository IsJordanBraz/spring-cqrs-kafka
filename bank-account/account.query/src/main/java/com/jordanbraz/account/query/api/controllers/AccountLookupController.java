package com.jordanbraz.account.query.api.controllers;

import com.jordanbraz.account.common.dto.BaseResponse;
import com.jordanbraz.account.query.api.dto.AccountLookupResponse;
import com.jordanbraz.account.query.api.dto.EqualityType;
import com.jordanbraz.account.query.api.queries.FindAccountByHolderQuery;
import com.jordanbraz.account.query.api.queries.FindAccountByIdQuery;
import com.jordanbraz.account.query.api.queries.FindAccountWithBalanceQuery;
import com.jordanbraz.account.query.api.queries.FindAllAccountsQuery;
...
@RestController
@RequestMapping(path = "/api/v1/bankAccountLooukup")
public class AccountLookupController {
    ...
    public ResponseEntity<AccountLookupResponse> getAllAccounts() {
        try {
            ...
            var safeErrorMessage = "Failed to complete";
