...
import com.jordanbraz.account.cmd.api.dto.OpenAccountResponse;
...
public class OpenAccountController {
    ...
    public ResponseEntity<BaseResponse> openAccount(@RequestBody OpenAccountCommand command) {
        ...
        try {
            ...
            return new ResponseEntity<>(new OpenAccountResponse("Bank Account Completed", id), HttpStatus.CREATED);
