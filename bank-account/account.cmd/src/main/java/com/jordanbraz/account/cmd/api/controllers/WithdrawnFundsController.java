...
import com.jordanbraz.account.cmd.api.commands.WithdrawFundsCommand;
...
public class WithdrawnFundsController {
    private final Logger logger = Logger.getLogger(WithdrawnFundsController.class.getName());
    ...
    public ResponseEntity<BaseResponse> depositFunds(
        ...
        try {
            ...
            return new ResponseEntity<>(new BaseResponse("Withdrawn Completed"), HttpStatus.OK);
